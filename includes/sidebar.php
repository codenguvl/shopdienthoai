            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseAcc" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./?page=view-account">Xem tài khoản</a>
                        <a class="nav-link" href="./?page=add-account">Thêm tài khoản</a>
                    </nav>
                </div>
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseProduct"
                    aria-expanded="false" aria-controls="collapseLayouts">
                    <div class="sb-nav-link-icon"><i class="fa fa-solid fa-mobile"></i></div>
                    Sản phẩm
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapseProduct" aria-labelledby="headingOne"
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./?page=view-product">Xem sản phẩm</a>
                        <a class="nav-link" href="./?page=add-product">Thêm sản phẩm</a>
                    </nav>
                </div>
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseCate"
                    aria-expanded="false" aria-controls="collapseLayouts">
                ...
                <div class="collapse" id="collapseCate" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./?page=view-cate">Xem danh mục</a>
                        <a class="nav-link" href="./?page=add-cate">Thêm danh mục</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseOrder" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./?page=view-unapproved-order">Đơn hàng chưa duyệt</a>
                        <a class="nav-link" href="./?page=view-order-approved">Đơn hàng đã duyệt</a>
                    </nav>
                </div>
            </div>
        </div>
